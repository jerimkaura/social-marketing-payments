...
const Agreement = ({address, agreement, makePayment}) => {
    const {name, image, description, price, appId, owner} =
        agreement;
                ...
                <Card.Body className="d-flex flex-column text-center">
                    ...
                    <Form className="d-flex align-content-stretch flex-row gap-2">
                        ...
                        <Button
                            ...
                            onClick={() => makePayment(agreement, price)}
                            className="w-75 py-3"
                        >
...
Agreement.propTypes = {
    ...
    agreement: PropTypes.instanceOf(Object).isRequired,
